...
Этот документ описывает, как интегрировать реальный бэкенд в приложение InCollab.
...
3. **Проекты** (`projectsApi`) - ТРЕБУЕТСЯ РЕАЛИЗАЦИЯ
   ```typescript
...
4. **Вакансии/Позиции** (`positionsApi`) - ТРЕБУЕТСЯ РЕАЛИЗАЦИЯ
   ```typescript
   GET    /api/v1/projects/{project_id}/positions/        # Список вакансий проекта
   POST   /api/v1/projects/{project_id}/positions/        # Создать вакансию
   PUT    /api/v1/positions/{id}                          # Обновить вакансию
   DELETE /api/v1/positions/{id}                          # Удалить вакансию
   ```

5. **Отклики** (`applicationsApi`) - ТРЕБУЕТСЯ РЕАЛИЗАЦИЯ
   ```typescript
   GET    /api/v1/applications/me                         # Мои отклики
   GET    /api/v1/projects/{project_id}/applications/     # Отклики на проект
   POST   /api/v1/positions/{position_id}/applications/   # Откликнуться
   PUT    /api/v1/applications/{id}/status                # Изменить статус отклика
   ```

6. **Навыки** (`skillsApi`) - ТРЕБУЕТСЯ РЕАЛИЗАЦИЯ
   ```typescript
   GET    /api/v1/skills/                                 # Список всех навыков
   GET    /api/v1/users/{user_id}/skills/                 # Навыки пользователя
   PUT    /api/v1/users/me/skills/                        # Обновить свои навыки
   ```
