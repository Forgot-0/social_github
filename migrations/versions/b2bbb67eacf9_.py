...
def upgrade() -> None:
    ...
    sa.Column('reactions_mode', sa.Enum('ALL', 'SOME', 'NONE', name='chatreactionsmode'), nullable=False),
    sa.Column('allowed_reactions', postgresql.JSONB(astext_type=sa.Text()), server_default='[]', nullable=False),
    ...
    sa.ForeignKeyConstraint(['role_id'], ['chat_roles.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('type', sa.Enum('TEXT', 'IMAGE', 'FILE', 'SYSTEM', 'REPLY', 'FORWARD', 'VOICE', 'VIDEO_NOTE', name='messagetype'), nullable=False),
    ...
    op.create_table('message_reaction_counters',
    ...
    op.create_index('ix_message_reaction_counters_chat_message', 'message_reaction_counters', ['chat_id', 'message_id'], unique=False)
    ...
    op.create_index('ix_message_reactions_chat_message', 'message_reactions', ['chat_id', 'message_id'], unique=False)
    op.create_index('ix_message_reactions_recent', 'message_reactions', ['message_id', 'emoji', 'created_at'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_message_reaction_counters_chat_message', table_name='message_reaction_counters')
