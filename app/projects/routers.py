...
from app.projects.routes.v1 import profiles, projects, positions, applications, project_roles

router_v1 = APIRouter()
router_v1.include_router(profiles.router, prefix="/profiles", tags=["profiles"])
